    ...
    <Drawer
      ...
      open={navDrawerOpen}>
        ...
        <div style={styles.avatar.div}>
          <Avatar src="../assets/img/avatar0.png"
                  size={50}
          ...
          <span style={styles.avatar.span}>
            ...
            {props.username}
              ...
              <IconMenu color={white}
                iconButtonElement={
                  <IconButton><ContentFilter color={orange}/></IconButton>
                }
                targetOrigin={{horizontal: 'right', vertical: 'top'}}
                anchorOrigin={{horizontal: 'right', vertical: 'top'}}>

                <MenuItem primaryText="Sign out" leftIcon={<SettingsPower/>} onClick={(event) => handleClick(event)} />
