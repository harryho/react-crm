...
import { getProduct, updateProduct, addProduct, loadCategories
...
class ProductFormPage extends React.Component {
   ...
   const { errorMessage, categoryList} = this.props;
    ...
    return (      
     ...
     <GridTile >
          ...
          value={this.state.product.category?this.state.product.category.id:0}
        ...
        >
          ...
          <GridTile  >
                <FormsyText
                    ...
                    onChange = {this.handleChange}
                    fullWidth={true}
                    value = {this.state.product.productName?this.state.product.productName:''}
                    validations={{
                    isWords: true
                    }}
                    validationErrors={{
  ...
  <GridTile >
                ...
                <GridTile>
                  { this.state.product && this.state.product.avatar &&
...
function mapStateToProps(state) {
  ...
  const {product, isFetching, categoryList, 
    updateSuccess, addSuccess, isAuthenticated, user} = productReducer;
